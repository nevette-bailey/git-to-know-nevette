...
const roles = [
  {
    ...
    period: "2025 – Present",
    tags: ["Python", "FastAPI", "PostgreSQL", "Celery", "Redis", "Supabase", "LLM Pipelines"],
    highlights: [
  ...
  },
  {
    ...
    period: "2024 – 2025",
    tags: ["TypeScript", "Node.js", "PostgreSQL", "GCP", "CI/CD", "Team Building"],
    highlights: [
  ...
  },
  {
    ...
    period: "2020 – 2024",
    tags: ["PHP", "Python", "React", "Payments", "Monetization", "A/B Experimentation"],
    highlights: [
  ...
  },
  {
    ...
    period: "2011 – 2019",
    tags: ["Research", "Data Analysis", "Lab Management", "Mentorship"],
    highlights: [
