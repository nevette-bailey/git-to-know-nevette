...
const icItems = [
    "Backend systems in PHP, Python and TypeScript",
                ...
                <div className="grid md:grid-cols-2 gap-8">
                    ...
                    >
                        <div className="flex items-start justify-between mb-6">
                            ...
                            <div
                                className="w-8 h-8 rounded-full border border-canvas-rule flex items-center justify-center group-hover:border-pink group-hover:bg-pink transition-colors duration-300">
                <span
                    className="font-body text-xs text-canvas-rule group-hover:text-canvas-DEFAULT transition-colors duration-300">
                  →
                </span>
                            </div>
                        </div>
