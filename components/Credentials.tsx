...
const education = [
    ...
    {degree: "M.Phil., Chemistry", institution: "Columbia University", year: "2015"},
    {degree: "M.A., Chemistry", institution: "Columbia University", year: "2013"},
    {degree: "M.S., Physical Chemistry", institution: "Northwestern University", year: "2011"},
    {degree: "B.A., Physical Chemistry", institution: "Northwestern University", year: "2011"},
    {
...
const fellowships = [
    ...
    },
    {
        ...
        org: "Columbia University, Department of Chemistry",
        year: "2011–2019",
    },
];
            ...
            <div className="max-w-5xl mx-auto px-6">
                ...
                <div className="grid md:grid-cols-3 gap-12 md:gap-8">
                        ...
                        <div className="mt-10 pt-8 border-t border-canvas-rule">
                            ...
                            <div
                                ...
                                <p className="font-body text-xs text-ink-muted mt-0.5">
                                    Etsy company-wide, top peer-nominated recipient
                                </p>
                    ...
                    <div ref={scholar} className="reveal reveal-delay-3">
                        ...
                        <div
                            className="border-l-2 border-canvas-rule hover:border-pink transition-colors duration-300 pl-4 mb-8">
                            <p className="font-body text-sm font-medium text-ink-DEFAULT">
